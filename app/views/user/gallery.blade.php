				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<div class="control-group">
							  <label class="control-label" for="date01">Fotograf</label>
							  <div class="controls">
					...
					<div class="box-content">
						...
						<ul class="thumbnails gallery">
							...
							<li id="image-1" class="thumbnail">
								<a style="background:url({{ $image->image_path }})" title="Sample Image 1" href="{{ $image->image_path }}"><img class="grayscale" src="{{ $image->image_path }}" alt="Sample Image 1"></a>
							</li>
							@endforeach
						</ul>
					</div>
