		...
		<div id="content" class="span10">
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="{{ URL::route('user/confirm_waiting') }}">Onay Bekleyen Yorumlarım</a>
					</li>
				</ul>
			</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  <th>Yorum Yapan</th>
								  <th>Yorum İçerigi</th>
								  <th>İşlemler (Onayla, Güncelle, Sil)</th>
							  </tr>
						  </thead>   
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="{{ URL::route('confirm', array('id' => $comment->id)) }}">
